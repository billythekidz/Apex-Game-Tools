namespace Apex.Demo.RTS.AI
{
    ...
    public sealed class StagingPointProximityToAttackPointScorer : OptionScorerBase<StagingPoint>
    {
        ...
        {
            var distance = (option.attackPoint - option.position).magnitude * this.factor;
